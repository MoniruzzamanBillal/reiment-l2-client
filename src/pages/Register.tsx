  ...
  return (
    <div className="RegisterContainer">
      <Wrapper className="formContainer py-14 ">
        {/*  */}
        <div className="    w-[95%] xsm:w-[85%] sm:w-[78%] md:w-[70%] xmd:w-[65%] lg:w-[55%] m-auto p-3 xsm:p-5 sm:p-7 md:p-10  rounded-md shadow-xl bg-gray-300 dark:bg-black100 backdrop-blur bg-opacity-60 dark:backdrop-blur  ">
