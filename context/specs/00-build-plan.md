...
10. **[10: Real-Time Order Notifications (Frontend)](./10-realtime-notifications-frontend.md)** — Socket.io client for live vendor/customer order updates. Candidate "depth" feature (alternative: server spec `07`). Depends on the backend plan (server spec `06`) landing first. Plan written, awaiting user review/approval before implementation.
